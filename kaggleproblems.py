...
train = pd.read_csv(r'C:\Users\BHARAJ\Desktop\kaggle data\HouseingPrices\train.csv')
test = pd.read_csv(r'C:\Users\BHARAJ\Desktop\kaggle data\HouseingPrices\test.csv')
